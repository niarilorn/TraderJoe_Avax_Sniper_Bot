...
class TXN():
    def __init__(self, token_address, quantity):
        ...
        self.MaxGasInAVAX, self.gas_price = self.setupGas()
    ...
    def setupGas(self):
        with open("./Settings.json") as f:
            keys = json.load(f)
        return keys['MaxTXFeeAVAX'], int(keys['GWEI_GAS'] * (10**9))
    ...
    def estimateGas(self, txn):
        ...
        maxGasAVAX = Web3.fromWei(gas * self.gas_price, "ether")
    ...
    def getOutputfromAVAXtoToken(self):
    ...
    def getOutputfromTokentoAVAX(self):
